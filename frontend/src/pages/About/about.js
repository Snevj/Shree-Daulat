...
import './about.css'
import stoneImage from '../About/stone.jpg'
    ...
    <div className='about'>
        <div className='row'>
            ...
            <div className='col-md-6 about-content'>
                <h1>About Us</h1>
                <p>Here’s a professional description for your trade export business specializing in natural stones:
...
**Our Vision**  
To be a leading provider of high-quality natural stones worldwide, recognized for our commitment to sustainability, ethical sourcing, and exceptional customer service.
...
**Our Commitment**  
We aim to bridge the gap between nature's beauty and human innovation, making timeless and durable natural stones accessible to international markets. Whether it’s a commercial infrastructure project or a luxury home design, we strive to bring elegance and functionality to every endeavor.

Let us help you transform your vision into reality with the enduring charm of natural stones.  

---

Let me know if you’d like to add specific countries you operate in, certifications, or unique selling points!</p>
            </div>
        </div>
    </div>
    </>
